...
import { batchCurrentStep } from "@utils";
import { useRouter } from "next/router";

const MaturationStarted = () => {
      ...
      <div className="flex flex-col items-center gap-8">
        <div className="flex w-2/3 flex-col gap-2">
          ...
          <Typography variant="h6" weight="medium" text="center">
            {t("step.successfullyStarted", {
              batchName: currentDairyBatch.batchName,
              step: t(`step.${batchCurrentStep(currentDairyBatch)}`),
            })}
          </Typography>
        </div>
...
export default MaturationStarted;
